...
<head>
    ...
    <title>Actualizar Estado de Membresía</title>
</head>
...
<body class="background-image-update-estado-membresia">
        ...
        <div class="container square xyz-in" xyz="small-100% origin-top">
            <div class="row">
                <div class="col-8 offset-2">
                    <h2 class="my-4 text-light text-center">UPDATE ESTADO MEMBRESÍA</h2>

                    <form id="formEditarEstado" action="<?= base_url('editar_estado_membresia') ?>" method="post">
                        <div class="row">
                            <!-- Columna izquierda -->
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="txt_estado_membresia_id" class="form-label text-light">
                                        ESTADO MEMBRESÍA ID:
                                    </label>
                                    <input type="text" name="txt_estado_membresia_id" id="txt_estado_membresia_id"
                                        class="form-control" value="<?= $datos['estado_membresia_id'] ?>" readonly>
                                </div>

                                <div class="mb-3">
                                    <label for="txt_membresia_id" class="form-label text-light">MEMBRESÍA ID:</label>
                                    <input type="text" name="txt_membresia_id" id="txt_membresia_id"
                                        class="form-control" value="<?= $datos['membresia_id'] ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="txt_cliente_id" class="form-label text-light">CLIENTE ID:</label>
                                    <input type="text" name="txt_cliente_id" id="txt_cliente_id"
                                        class="form-control" value="<?= $datos['cliente_id'] ?>">
                                </div>
                            </div>
    ...
    <script>
        ...
        document.getElementById("formEditarEstado").addEventListener("submit", function (e) {
            e.preventDefault();
            Swal.fire({
                title: "¿Guardar cambios?",
                text: "Se actualizará la información del estado de membresía.",
                icon: "question",
