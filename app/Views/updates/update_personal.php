        ...
        <div class="container square xyz-in" xyz="small-100% origin-top">
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <form id="formEditarPersonal" action="<?= base_url('editar_personal') ?>" method="post">
                        <div class="row">
                            <!-- Columna izquierda -->
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    <label for="txt_fecha_contratacion" class="form-label text-light">FECHA CONTRATACIÓN:</label>
                                    <input type="date" name="txt_fecha_contratacion" id="txt_fecha_contratacion"
                                        class="form-control" value="<?= $datos['fecha_contratacion'] ?>">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="txt_sede" id="txt_sede" class="form-control" required>
                                        ...
                                        <option value="CAES"   <?= ($datos['sede_principal'] ?? '') === 'CAES'   ? 'selected' : '' ?>>CAES</option>
                                        <option value="Zona14" <?= ($datos['sede_principal'] ?? '') === 'Zona14' ? 'selected' : '' ?>>Zona14</option>
                                        <option value="Todas"  <?= ($datos['sede_principal'] ?? '') === 'Todas'  ? 'selected' : '' ?>>Todas</option>
                                    </select>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        document.getElementById("formEditarPersonal").addEventListener("submit", function (e) {
            ...
            Swal.fire({
                ...
                text: "Se actualizará la información del personal.",
                icon: "question",
