...
<head>
    ...
    <title>Actualizar Plan Nutricional</title>
</head>
        ...
        <div class="container square xyz-in" xyz="small-100% origin-top">
            <div class="row">
                <div class="col-8 offset-2">
                    ...
                    <form id="formEditarPlan" action="<?= base_url('editar_plan_nutricion') ?>" method="post">
                        <div class="row">
                            <!-- Columna izquierda -->
                            <div class="col-md-6">
                                <div class="mb-3">
    ...
    <script>
        ...
        document.getElementById("formEditarPlan").addEventListener("submit", function (e) {
            ...
            Swal.fire({
                ...
                text: "Se actualizará el plan nutricional.",
                icon: "question",
