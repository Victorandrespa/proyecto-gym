...
<body class="container mt-4 background-image-personal-main">
        ...
        <div class="row align-items-center">
            ...
            <div class="col">
                ...
                <div class="d-flex flex-row justify-content-between align-items-center item-group" xyz="fade stagger">
                    <a href="verHome" class="btn btn btn-outline-dark text-light border border-light square xyz-in">
                        Menu Principal <i class="bi bi-house"></i>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="d-flex justify-content-around mt-3">
        <div class="d-grid gap-2 mt-5 item-group" style="width: 50%;">
            <a href="verActividadPersonal"
               class="btn btn-outline-dark fs-4 text-light rounded-pill border border-light square xyz-in border border-5"
               xyz="duration-20 ease-in-out-back flip-up-100% iterate-infinite">
               Gestionar Actividades <i class="bi bi-flag"></i>
            </a>

            <!-- Button trigger modal: Registro Cliente -->
            <button type="button"
                class="btn btn-outline-dark fs-4 text-light rounded-pill border border-light square xyz-in border border-5"
            ...
            <a href="verClientePersonal"
               class="btn btn-outline-dark fs-4 text-light rounded-pill border border-light square xyz-in border border-5"
               xyz="duration-20 ease-in-out-back flip-up-100% iterate-infinite">
               Base de datos Clientes <i class="bi bi-database"></i>
            </a>

            <!-- Button trigger modal: Pago -->
            <button type="button"
                class="btn btn-outline-dark fs-4 text-light rounded-pill border border-light square xyz-in border border-5"
            ...
            <a href="verEstadoMembresiaCliente"
               class="btn btn-outline-dark fs-4 text-light rounded-pill border border-light square xyz-in border border-5"
               xyz="duration-20 ease-in-out-back flip-up-100% iterate-infinite">
               Estados membresias <i class="bi bi-file-bar-graph"></i>
            </a>

            <a href="verHistorialMedicionPersonal"
               class="btn btn-outline-dark fs-4 text-light rounded-pill border border-light square xyz-in border border-5"
               xyz="duration-20 ease-in-out-back flip-up-100% iterate-infinite">
               Historial Medicion <i class="bi bi-clipboard-check"></i>
            </a>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalPagoLabel">Realizar un Pago</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="agregarPagoPersonal" method="post" id="formPagoPersonal">
                        ...
                        <input type="number" step="0.01" name="txt_monto" id="txt_monto" class="form-control">
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <button type="submit" class="btn btn-outline-dark mt-2">Guardar</button>
                        </div>
                    </form>
                </div>
    ...
    <div class="modal fade" id="modalRegistroCliente" tabindex="-1" aria-labelledby="modalRegistroClienteLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="modalRegistroClienteLabel">Nuevo Cliente</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="agregarCliente" method="post" id="formRegistroCliente">
                        <input type="hidden" name="txt_cliente_id" id="txt_cliente_id_hidden" class="form-control">
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        const formPago = document.getElementById('formPagoPersonal');
        if (formPago) {
          formPago.addEventListener('submit', function (e) {
            e.preventDefault();
            Swal.fire({
              title: "¿Registrar pago?",
              text: "Se guardará el nuevo pago en la base de datos.",
              icon: "question",
        ...
        if (formCliente) {
          formCliente.addEventListener('submit', function (e) {
            ...
            Swal.fire({
              ...
              text: "Se guardará la información del nuevo cliente.",
              icon: "question",
              showCancelButton: true,
              confirmButtonColor: "#198754",
              cancelButtonColor: "#d33",
